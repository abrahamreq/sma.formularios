...
public class FormSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FormPackage.EDITABLE: {
				Editable editable = (Editable)theEObject;
				T result = caseEditable(editable);
				if (result == null) result = caseElement(editable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormPackage.INPUT: {
				...
				if (result == null) result = caseEditable(input);
				if (result == null) result = caseElement(input);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormPackage.SELECTION_LIST: {
				SelectionList selectionList = (SelectionList)theEObject;
				T result = caseSelectionList(selectionList);
				if (result == null) result = caseEditable(selectionList);
				if (result == null) result = caseElement(selectionList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormPackage.TEXT_AREA: {
				...
				if (result == null) result = caseEditable(textArea);
